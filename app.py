...
def main():
	...
	parser.add_argument('--gift-to', help='--gift-to 628xxx', dest='gift_to', type=str)
	...
	arguments.subscriber_number_range = arguments.subscriber_number_range.split('-') if arguments.subscriber_number_range else []
	...
	try:
		...
		myxl.gift_to = arguments.gift_to
		...
		if not arguments.subscriber_number_range:
			arguments.subscriber_number_range = myxl.get_default_subscriber_number()
